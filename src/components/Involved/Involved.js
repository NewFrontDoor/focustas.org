...
const Involved = () => (
  <div id="involved" className="parent-component">
    <h2>Get involved</h2>
    <div id="icon2"></div>
    <Blurb h3="Join our list"><p>Do you want to keep up-to-date with our events? Contact <a href="mailto:staff@focustas.org">staff@focustas.org</a> to join our email list.</p></Blurb>
