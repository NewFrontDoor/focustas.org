...
const About = () => (
  <div id="about" className="parent-component">
    ...
    <Blurb h3="Who we are">
      <p>
        FOCUS is a Christian international student society of the Tasmanian University Union (TUU) on the Hobart campus of the University of Tasmania. Our society and our staff are also part of the
        {" "}
